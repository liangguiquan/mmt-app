  ...
  <div class="seller" ref="sellerView">
    <div class="seller-wrapper">
      ...
      <div class="tip-wrapper">
        <div class="delivery-wrapper">配送服务：{{seller.app_deelivery_tip}}</div>
        <div class="shipping-wrapper">配送服务：{{seller.shipping_time}}</div>
      </div>
      <Split></Split>
      ...
      .then(response => {
        ...
        this.$nextTick(() => {
          if (this.seller.poi_env.thumbnails_url_list) {
            ...
            let marginR = 11;
            let width = (marginR + imgW) * this.seller.poi_env.thumbnails_url_list.length;
